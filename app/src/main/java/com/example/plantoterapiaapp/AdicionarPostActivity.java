...
public class AdicionarPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdicionarPostActivityViewModel vm = new ViewModelProvider(this).get(AdicionarPostActivityViewModel.class);
        ...
        btnAddItem.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AdicionarPostActivityViewModel vm = new ViewModelProvider(AdicionarPostActivity.this).get(AdicionarPostActivityViewModel.class);
                Uri selectedPhotoLocation = vm.getSelectedPhotoLocation();
                if(selectedPhotoLocation == null){ //Se não houver uma imagem selecionada, será exibida uma mensagem de erro na tela
                    Toast.makeText(AdicionarPostActivity.this, "É necessário selecionar uma imagem", Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                if(title.isEmpty()){
                    Toast.makeText(AdicionarPostActivity.this, "É necessário escrever um nome", Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                if(description.isEmpty()){
                    Toast.makeText(AdicionarPostActivity.this, "É necessário escrever uma descrição", Toast.LENGTH_LONG).show();
                    return;
                }
